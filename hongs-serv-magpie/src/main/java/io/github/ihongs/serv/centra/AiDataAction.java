...
public class AiDataAction extends DataAction {
    ...
    @Action("aifind")
    public void aifind(ActionHelper helper) throws CruxException {
        ...
        // 限定最多对话轮数
        int limit = CoreConfig.getInstance("magpie").getProperty("magpie.llm.find.agent.max.round", 10) * 2;
